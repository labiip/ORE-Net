...
from areconv.modules.ops import apply_transform, pairwise_distance, get_rotation_translation_from_transform
from areconv.utils.registration import compute_transform_mse_and_mae
...
def anisotropic_transform_error(gt_transforms, transforms, reduction='mean'):
    ...
    r_mse, r_mae, t_mse, t_mae = compute_transform_mse_and_mae(gt_transforms_array, transforms_array)

...
from areconv.utils.pointcloud import (
    random_sample_rotation,
    random_sample_rotation_v2,
    get_transform_from_rotation_translation,
    uniform_2_sphere
)
from areconv.utils.registration import get_correspondences, compute_overlap, compute_overlap_mask

class ToothPairDataset(torch.utils.data.Dataset):
    def __init__(
        self,
        dataset_root,
        subset,
        ...
        super(ToothPairDataset, self).__init__()
    ...
    def __getitem__(self, index):
        ...
        src_points = data['src_pcd']  
        ref_points = data['tgt_pcd']  
        transform = data['gt_pose']   

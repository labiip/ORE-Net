...
_C.output_dir = osp.join(_C.root_dir, "output")
...
_C.train.augmentation_rotation = 5.0
_C.train.augmentation_crop = False
_C.train.point_keep_ratio = 0.7
_C.train.matching_radius = 0.2
...
# ransac
_C.ransac = edict()
_C.ransac.distance_threshold = 0.1
...
_C.backbone.init_voxel_size = 0.052
...
_C.coarse_matching.overlap_threshold = 0.2
...
_C.fine_matching.acceptance_radius = 0.2
...
_C.coarse_loss.positive_margin = 0.2
_C.coarse_loss.negative_margin = 1.4
_C.coarse_loss.positive_optimal = 0.2
_C.coarse_loss.negative_optimal = 1.4
_C.coarse_loss.log_scale = 24
_C.coarse_loss.positive_overlap = 0.2

# loss - Fine level
_C.fine_loss = edict()
_C.fine_loss.positive_radius = 0.1
_C.fine_loss.negative_radius = 0.4
_C.fine_loss.positive_margin = 0.2
